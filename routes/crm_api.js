 ...
 * event_id(type: text) - Filter by a given event.
 * session_id(type: text) - Filter by a given session.
 * channel_name(type: text) - Filter by onsale channel name.
 ...
 * event_id(type: text) - Filter by a given event.
 * session_id(type: text) - Filter by a given session.
 * channel_name(type: text) - Filter by onsell channel name.
 * page(type: number) - Paginate response to the given page number
 * page_size(type: number) - Size of the each page requested.
